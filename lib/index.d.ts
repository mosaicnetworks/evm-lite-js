...
declare module 'evm-lite-lib' {
    ...
    export { default as SolidityContract } from 'evm-lite-lib/evm/classes/SolidityContract';
    ...
    export { BaseContractSchema } from 'evm-lite-lib/evm/classes/SolidityContract';
    ...
    export { default as AddressType } from 'evm-lite-lib/evm/types/lib/AddressType';
...
declare module 'evm-lite-lib/evm/EVMLC' {
    ...
    import SolidityContract, { BaseContractSchema } from 'evm-lite-lib/evm/classes/SolidityContract';
...
declare module 'evm-lite-lib/evm/classes/Account' {
    ...
    export default class Account {
        ...
        static signTransaction(tx: TX | Transaction): Promise<SignedTransaction>;
        balance: number;
        nonce: number;
...
declare module 'evm-lite-lib/evm/client/BaseClient' {
    export const request: (options: Options, tx?: string | undefined) => Promise<string>;
