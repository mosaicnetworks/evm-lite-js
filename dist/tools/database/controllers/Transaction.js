...
var Transaction_1 = require("../filters/Transaction");
var Transaction_2 = require("../schemas/Transaction");
var Transaction = /** @class */ (function () {
    function Transaction(database) {
        this.database = database;
        this.schema = Transaction_2.default;
    }
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Transaction_1.default(transactions)];
                }
            });
        });
    };
